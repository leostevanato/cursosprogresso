...
class secondary extends core_secondary {
    ...
    /**
     * Custom module construct for cursosprogresso
     *
     ...
     * If not explicitly defined, the nodes will be added to the secondary root node by default.
     */
